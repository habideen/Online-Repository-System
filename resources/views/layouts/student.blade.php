...
<head>
  ...
  <!-- Favicon icon -->
  <link rel="icon" type="image/png" sizes="16x16" href="/assets/img/oau_icon.ico">
...
<body>
  ...
  <div id="main-wrapper">
    ...
    <div class="nav-header">
      <a href="/" class="brand-logo">
        <div class="logo-abbr">
          <img src="/assets/img/oau_logo.png" class="img-fluid" alt="logo">
        </div>
          ...
          <div class="tab-pane fade active show" id="chat" role="tabpanel">
            ...
            <div class="card chat dlab-chat-history-box d-none">
              <div class="card-header chat-list-header text-center">
                ...
                <div class="dropdown">
                  <a href="javascript:void(0)" data-bs-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg"
                      xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24"
                      version="1.1">
                      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24" />
    ...
    <!--**********************************
            Header start
        ***********************************-->
    @include('components.panel.panel-headbar')
    <!--**********************************
    ...
    <!--**********************************
            Sidebar start
        ***********************************-->
    @include('components.panel.student-sidebar')
    <!--**********************************
            Sidebar end
        ***********************************-->
    ...
    @include('components.panel.logout-modal')
    ...
    <div class="footer">
      <div class="copyright">
        <p>Developed by <a href="https://www.linkedin.com/in/habideen-ibrahim/" target="_blank">Bravytech</a> 2022
        </p>
      </div>
    </div>
    <!--**********************************
  ...
  @yield('script_top')
  @include('components.panel.script')
  @yield('script')
  @yield('bottom_css')
</body>
