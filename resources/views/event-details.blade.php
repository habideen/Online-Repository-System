...
<body>
    ...
    <div class="vs-menu-area text-center"><button class="vs-menu-toggle"><i class="fal fa-times"></i></button>
      ...
      <div class="vs-mobile-menu">
        <ul>
          ...
          <li class="menu-item-has-children"><a href="event-details.html#">Pages</a>
            <ul class="sub-menu">
  ...
  <div class="popup-search-box d-none d-lg-block"><button class="searchClose"><i class="fal fa-times"></i></button>
    <form action="event-details.html#"><input type="text" class="border-theme" placeholder="What are you looking for">
            ...
            <div class="header-links">
              <ul>
                <li><i class="fas fa-phone-alt"></i>Phone: <a
                    href="https://html.vecurosoft.com/educino/demo/+4402076897888">+44 (0) 207 689 7888</a></li>
                <li><i class="fas fa-envelope"></i>Email: <a href="mailto:info@company.co.uk">info@company.co.uk</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col col-xl-auto d-none d-md-block"><a class="user-login" href="login-register.html"><i
                class="fas fa-user-circle"></i> Login & Register</a></div>
          <div class="col-md-auto text-center">
            <div class="header-social"><a href="event-details.html#"><i class="fab fa-facebook-f"></i></a> <a
                href="event-details.html#"><i class="fab fa-twitter"></i></a> <a href="event-details.html#"><i
        ...
        <div class="container position-relative z-index-common">
          <div class="row align-items-center justify-content-between">
            ...
            <div class="col text-end text-xl-center">
              <nav class="main-menu menu-style1 d-none d-lg-block">
                <ul>
                  ...
                  <li class="menu-item-has-children mega-menu-wrap"><a href="event-details.html#">Pages</a>
                    <ul class="mega-menu">
                      <li><a href="event-details.html#">Pagelist 1</a>
                        <ul>
                          <li><a href="index.html">Demo Style 1</a></li>
                          <li><a href="index-2.html">Demo Style 2</a></li>
                          <li><a href="index-3.html">Demo Style 3</a></li>
                      ...
                      <li><a href="event-details.html#">Pagelist 2</a>
                        <ul>
                          <li><a href="course.html">Courses 1</a></li>
                          <li><a href="courses-2.html">Courses 2</a></li>
                          <li><a href="course-details.html">Courses Details 1</a></li>
                      ...
                      <li><a href="event-details.html#">Pagelist 3</a>
                        <ul>
                          <li><a href="academic.html">Academic</a></li>
                          <li><a href="academic-program.html">Academic Program</a></li>
                          <li><a href="program-details.html">Program Details</a></li>
                      ...
                      <li><a href="event-details.html#">Pagelist 4</a>
                        <ul>
                          <li><a href="team.html">Our Tutors</a></li>
                          <li><a href="team-details.html">Tutor Details</a></li>
                          <li><a href="become-tutor.html">Become Tutor</a></li>
            ...
            <div class="col-auto d-none d-xl-block">
              <div class="header-btns"><button type="button" class="searchBoxTggler"><i
                    class="far fa-search"></i></button> <a href="find-program.html" class="vs-btn style4"><i
    ...
    <div class="container">
      <div class="event-style1 layout2">
        ...
        <div class="event-body">
          ...
          <div class="event-meta"><span><i class="fas fa-clock"></i>8:00 AM - 5:00 PM</span> <span><i
                class="far fa-map"></i>Online</span> <span><i class="far fa-user"></i>20 Speaker</span></div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 col-lg">
          <h2 class="border-title2 mb-3">Tech Online</h2>
          <p>Preply tutors teach 800,000+ students globally. Join us and you’ll have everything you need to teach
            successfully Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
      ...
      <div class="mega-hover rounded-20 mb-4 pb-xl-2"><img src="assets/img/about/event-details-1.jpg" alt="teaching">
      </div>
      ...
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
        ...
        laborums nisi ut aliquip ex ea commosi ut aliquip ex ea commodo cons magna aliqua. Ut enim ad minim veniam
        equatdo.</p>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
        magna aliqua. Ut enim ad minim veniam, quis giat nulla pariatur. Excepteur sint occaecat cupidatat non proident,
        sunt in culpa qui officia deserunt mollit anim id est laborums nisi ut aliquip ex ea commosi ut aliquip ex ea
        commodo cons magna aliqua. Ut enim ad minim veniam equatdo.</p>
      <div class="row pt-3">
        <div class="col-md-4 mb-4 pb-xl-3">
          <div class="mega-hover rounded-20"><img src="assets/img/about/event-details-2.jpg" alt="computer learning">
          </div>
        </div>
        <div class="col-md-4 mb-4 pb-xl-3">
          <div class="mega-hover rounded-20"><img src="assets/img/about/event-details-3.jpg" alt="computer learning">
          </div>
        </div>
        <div class="col-md-4 mb-4 pb-xl-3">
          <div class="mega-hover rounded-20"><img src="assets/img/about/event-details-4.jpg" alt="computer learning">
          </div>
        </div>
      </div>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
              ...
              <div class="accordion-body">
                <p>Sometimes, we don’t approve tutor profiles at the first attempt because the profile photo, video or
                  description doesn’t meet our requirements. Make sure you use a real photo of yourself, take the time
                  to record a short video and describe your strengths</p>
              </div>
            </div>
          </div>
          <div class="accordion-item">
          ...
          <div class="col-md-6 col-xl-auto">
            <div class="widget footer-widget">
              <div class="vs-widget-about">
                ...
                <p class="footer-text">Lorem ipsum dolor sit amet, consectet rem ips dolor sit amet. sum dolor sit amet,
                  consectet e dolor sit amet, comod.</p>
                <p class="footer-info"><i class="fal fa-phone-alt"></i><a class="text-inherit"
                    href="tel:++11234562228">(00) 123 456 789</a></p>
                <p class="footer-info"><i class="fal fa-envelope"></i><a class="text-inherit"
                    href="mailto:info@example.com">hello@domainname.com</a></p>
              </div>
            </div>
          </div>
            ...
            <div class="widget nav_menu footer-widget">
              ...
              <div class="menu-all-pages-container footer-menu">
                <ul class="menu">
                  ...
                  <li><a href="https://html.vecurosoft.com/educino/demo/find-tutor.htm">Hire teachers</a></li>
            ...
            <div class="widget footer-widget">
              ...
              <div class="recent-post-wrap">
                <div class="recent-course">
                  <div class="media-img"><a href="course-details.html"><img
                        src="assets/img/course/recent-course-1-1.jpg" alt="Blog Image"></a></div>
                  <div class="media-body">
                    <div class="recent-course-meta"><a href="team-details.html">BY ANA WATSON</a></div>
                    <h4 class="post-title"><a class="text-inherit" href="course-details.html">Web Coding and Apache
                        Basics theory</a></h4>
                  </div>
                </div>
                <div class="recent-course">
                  <div class="media-img"><a href="course-details.html"><img
                        src="assets/img/course/recent-course-1-2.jpg" alt="Blog Image"></a></div>
                  <div class="media-body">
                    <div class="recent-course-meta"><a href="team-details.html">BY ANA WATSON</a></div>
                    <h4 class="post-title"><a class="text-inherit" href="course-details.html">Tadit Soul Can Tech Us
                        About Web Docan</a></h4>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row justify-content-between align-items-center">
          ...
          <div class="col-auto d-none d-lg-block">
            <div class="social-style1"><a href="event-details.html#"><i class="fab fa-facebook-f"></i>Facebook</a> <a
                href="event-details.html#"><i class="fab fa-twitter"></i>Twitter</a> <a href="event-details.html#"><i
                  class="fab fa-linkedin-in"></i>Linked In</a></div>
          </div>
        </div>
      </div>
    </div>
  </footer><a href="event-details.html#" class="scrollToTop scroll-btn"><i class="far fa-arrow-up"></i></a>
