        ...
        <ul class="navbar-nav header-right">
          <li class="nav-item dropdown notification_dropdown d-none">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <div id="dlab_W_Notification1" class="widget-media dlab-scroll p-3 height230">
                <ul class="timeline">
                  <li>
                    <div class="timeline-panel">
                      <div class="media me-2">
                        <img alt="image" width="50" src="/panel/images/avatar/1.jpg">
                      </div>
          ...
          <li class="nav-item dropdown header-profile">
            <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
              <img src="/panel/images/profile/17.jpg" width="20" alt="" />
              <div class="header-info">
                <span class="text-black">{{ Auth::user()->first_name . ' ' . substr(Auth::user()->first_name, 0, 1)
                  }}</span>
                <p class="fs-12 mb-0">{{ Auth::user()->account_type }}</p>
              </div>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              <a href="/{{strtolower(Auth::user()->account_type)}}/profile" class="dropdown-item ai-icon">
