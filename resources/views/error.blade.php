...
<head>
  ...
  <title>Educino - Online Courses and Education HTML Template - Error Page</title>
...
<body>
    ...
    <div class="vs-menu-area text-center"><button class="vs-menu-toggle"><i class="fal fa-times"></i></button>
      ...
      <div class="vs-mobile-menu">
        <ul>
          ...
          <li class="menu-item-has-children"><a href="error.html#">Pages</a>
            <ul class="sub-menu">
  ...
  <div class="popup-search-box d-none d-lg-block"><button class="searchClose"><i class="fal fa-times"></i></button>
    <form action="error.html#"><input type="text" class="border-theme" placeholder="What are you looking for"> <button
      ...
      <div class="container">
        <div class="row justify-content-between align-items-center gx-50">
          ...
          <div class="col-md-auto text-center">
            <div class="header-social"><a href="error.html#"><i class="fab fa-facebook-f"></i></a> <a
                href="error.html#"><i class="fab fa-twitter"></i></a> <a href="error.html#"><i
            ...
            <div class="col text-end text-xl-center">
              <nav class="main-menu menu-style1 d-none d-lg-block">
                <ul>
                  ...
                  <li class="menu-item-has-children mega-menu-wrap"><a href="error.html#">Pages</a>
                    <ul class="mega-menu">
                      <li><a href="error.html#">Pagelist 1</a>
                        <ul>
                          <li><a href="index.html">Demo Style 1</a></li>
                          <li><a href="index-2.html">Demo Style 2</a></li>
                          <li><a href="index-3.html">Demo Style 3</a></li>
                      ...
                      <li><a href="error.html#">Pagelist 2</a>
                        <ul>
                          <li><a href="course.html">Courses 1</a></li>
                          <li><a href="courses-2.html">Courses 2</a></li>
                          <li><a href="course-details.html">Courses Details 1</a></li>
                      ...
                      <li><a href="error.html#">Pagelist 3</a>
                        <ul>
                          <li><a href="academic.html">Academic</a></li>
                          <li><a href="academic-program.html">Academic Program</a></li>
                          <li><a href="program-details.html">Program Details</a></li>
                      ...
                      <li><a href="error.html#">Pagelist 4</a>
                        <ul>
                          <li><a href="team.html">Our Tutors</a></li>
                          <li><a href="team-details.html">Tutor Details</a></li>
                          <li><a href="become-tutor.html">Become Tutor</a></li>
    ...
    <div class="container">
      <div class="row flex-row-reverse text-center text-xl-start">
        <div class="col-xl-6 col-xxl-7 text-xl-end">
          <div class="error-img"><img src="assets/img/shape/error-1-1.png" alt="error image"></div>
        </div>
        <div class="col-xl-6 col-xxl-5 align-self-center">
          <div class="error-content">
            <h1 class="error-title">oooops!</h1>
            <h2 class="error-title2">Page Not Found</h2>
            <p class="error-text">the resource you are looking for might have been removed had its name changed or is
              temporarily</p>
            <form action="error.html#" class="search-inline"><input type="text" class="form-control"
                placeholder="Enter Your Keyword...."> <button><i class="far fa-search"></i></button></form><a
              href="index.html" class="vs-btn"><i class="fas fa-home me-2 pe-1"></i>Back To Home</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-between align-items-center">
          ...
          <div class="col-auto d-none d-lg-block">
            <div class="social-style1"><a href="error.html#"><i class="fab fa-facebook-f"></i>Facebook</a> <a
                href="error.html#"><i class="fab fa-twitter"></i>Twitter</a> <a href="error.html#"><i
                  class="fab fa-linkedin-in"></i>Linked In</a></div>
          </div>
        </div>
      </div>
    </div>
  </footer><a href="error.html#" class="scrollToTop scroll-btn"><i class="far fa-arrow-up"></i></a>
